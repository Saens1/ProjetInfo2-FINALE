...
public class Jail extends JFrame{
	...
	public Jail(Game game){
	    ...
	    JLabel label_title = new JLabel("You're in jail!");
		...
		JLabel label_money = new JLabel("Go play Homer to go out");
		label_money.setFont(new Font("Times New Roman", Font.BOLD, 30));
		label_money.setOpaque(true);
		label_money.setForeground(Color.BLACK);
		this.add(label_money);
		label_money.setBounds(260, 50, 400, 50);
